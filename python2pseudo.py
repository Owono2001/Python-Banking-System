...
python_file = 'SuperUser_Fun.py'
work_file = None

basic_conversion_rules = {"for": "FOR", "=": "=", "if": "IF", "==": "==", "while": "WHILE", "until": "UNTIL", "import": "IMPORT", "class": "DEFINE CLASS", "def": "DEFINE", "else:": "ELSE:", "elif": "ELSEIF", "except:": "EXCEPT:", "try:": "TRY:", "pass": "PASS", "in": "IN"}
prefix_conversion_rules = {"=": "", "#F": "CALL "}
advanced_conversion_rules = {"print": "DISPLAY", "return": "RETURN", "input": "INPUT"}
